...
def write_happy_inside_circle(text_color, x, y):
    ...
    my_turtle_cursor.begin_fill()
    my_turtle_cursor.pendown()
    my_turtle_cursor.write("Happy Sweet", font=("sans-serif", 24, "bold"))
    my_turtle_cursor.getscreen().update()
...
def write_birthday_inside_circle(text_color, x, y):
    ...
    my_turtle_cursor.begin_fill()
    my_turtle_cursor.pendown()
    my_turtle_cursor.write("Seventeen", font=("sans-serif", 24, "bold"))
    my_turtle_cursor.getscreen().update()
...
write_happy_inside_circle("#000000", -80, y_coordinate + 240)
...
def draw_circle_on_top_of_stick(fill_color, border_color, x, y, radius):
    ...
    my_turtle_cursor.color(fill_color)
    my_turtle_cursor.fillcolor(border_color)
    my_turtle_cursor.goto(x, y - radius)
    my_turtle_cursor.pendown()
    my_turtle_cursor.begin_fill()
    my_turtle_cursor.circle(radius)
    my_turtle_cursor.end_fill()
...
def write_text(text, text_color, x, y, font_size):
    my_turtle_cursor.penup()
    my_turtle_cursor.color(text_color)
    my_turtle_cursor.goto(x, y)
    my_turtle_cursor.pendown()
    my_turtle_cursor.write(text, align="center", font=("sans-serif", font_size, "bold"))
    my_turtle_cursor.getscreen().update()

my_turtle_screen.bgcolor("#FFFDD0")


# Write birthday wish below the cake
write_text("Happy birthday! May all your dreams come true", "#000000", 0, y_coordinate - 160, 14)
write_text("and your life is always full of happiness.", "#000000", 0, y_coordinate - 180, 14)
write_text("May your special day be as beautiful as you are!", "#000000", 0, y_coordinate - 200, 14)
